...
/*
    Adoped from https://github.com/thankcreate/power-fsm-viewer, vizdraw.js
    Converted to ES6 module.
*/
const VIZDRAW_VER = "0.0.1";
console.log(`here is vizdraw-mod.js, module,${VIZDRAW_VER}`);
...
export function renderJssm(jssmDot) {
// dot
}