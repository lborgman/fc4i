...
function collide(radius) {
  ...
  function force() {
    ...
    for (var k = 0; k < iterations; ++k) {
      tree =
          (nDim === 1 ? binarytree(nodes, x$2)
          :(nDim === 2 ? quadtree(nodes, x$2, y$2)
          :(nDim === 3 ? octree(nodes, x$2, y$2, z$2)
          :null
      ))).visitAfter(prepare);
...
export { center as forceCenter, collide as forceCollide, link as forceLink, manyBody as forceManyBody, radial as forceRadial, simulation as forceSimulation, x as forceX, y as forceY, z as forceZ };
